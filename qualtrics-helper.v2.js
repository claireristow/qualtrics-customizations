...
(function() {
    window.QualtricsHelper = {
        ...
        <div class="flex-wrapper">
            ...
            var plug_html = document.querySelector('.plug-container').innerHTML;
            var new_plug = "<div class='plug-wrapper'>" + plug_html + "</div>";
            document.querySelector('.plug-container').innerHTML = new_plug;
            document.querySelector('.plug-wrapper')?.insertAdjacentHTML('afterbegin', footerHTML);
        }
    };
})();
